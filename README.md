...
## BundleKit Project Docs

For BundleKit-specific implementation details, validation results, and release readiness status, see:

- [`docs/theme-integration-release-readiness.md`](docs/theme-integration-release-readiness.md)
- [`PROJECT_PROGRESS.md`](PROJECT_PROGRESS.md)

Current BundleKit architecture highlights:

- One consolidated Shopify automatic discount node per shop (`PRODUCT` + `ORDER` classes).
- Theme-owned storefront rendering from `product.metafields.bundle_app.config`.
- No app proxy route and no theme app extension in this repository.
- Admin "Re-sync Theme + Discounts" action for operational recovery.
